...
[] spawn {
    while {true} do
    {
        ...
        if ((headgear player != "TAC_SF10")||(headgear player != "H_ALFR_Gasmask")) then {antidote1 = 2583}; // Player has no Suit
        if ((headgear player == "TAC_SF10")||(headgear player == "H_ALFR_Gasmask")) then {antidote1 = 2581}; // Player carries the Gas Suit
