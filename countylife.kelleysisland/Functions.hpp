...
class Life_Client_Core {
    ...
    class Actions {
        ...
        class ticketAction {};
        class unrestrain {};
        class tieingAction {}; //civinteraction
        class tieingActionb {}; //civinteraction
        class vaultOpen {};
        class lockvault {};
        class bandagesAction {};
        class morphineAction {};
        class medkitAction {};
        class crushAction {};
        class revokeDriverLicense {};
        class revokeGunLicense {};
    };
    ...
    class Civilian {
        ...
        class civescort {}; //civinteraction
        class civstopescort {}; //civinteraction
        class tieing {}; //zipties
        class tieingb {}; //zipties
    };
    ...
    class Cop {
        ...
        class backup {};
        class callBackup {};
        class emsInteractionMenu {}; //emsInteraction
        class seizeObjects {};
        class test {};
    ...
    class Functions {
        ...
        class whereAmI {};
        class seatbelt {};
        class untie {}; //un-ziptie
        class untieb {}; //un-ziptie
        class robstore {};
        class CallMenu {}; //PHONE
        class CallSomebody {};
        class checkCall {};
        class answercall {};
        class answered {};
        class noanswer {};
        class ringPlayer {}; //remoteEXEC
        class busyAnswer {}; //remoteEXEC
        class callProgress {};
        class resetCall {};
        class hangup {};
        class ChangePolice {};
