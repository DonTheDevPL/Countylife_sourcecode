...
/* System Settings */
    ...
    bank_civ = 12500; //Amount of cash in bank for new civillians
    ...
    paycheck_med = 300; //Payment for medics
	...
	vehicle_insurance_multiplier_CIVILIAN = .5; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier 
	vehicle_insurance_multiplier_COP = .5; //Cop Vehicle Insurance Price = Vehicle Buy Price * multiplier 
	vehicle_insurance_multiplier_MEDIC = .5; //Medic Vehicle Insurance Price = Vehicle Buy Price * multiplier 
