...
HRP_fnc_addExp = {
    ...
    [0] call HRP_fnc_clientSendUpdateToServer;
    [1] call HRP_fnc_clientSendUpdateToServer;
    [2] call HRP_fnc_clientSendUpdateToServer;
    [3] call HRP_fnc_clientSendUpdateToServer;
