/*
	Author: Ben Harris
	Description: Sets Immigration Data
*/
HRP_fnc_immigrationLbChanged = {
	...
	_data = call compile _rawData;
		...
		ctrlSetText [77781, _data select 4];
		ctrlSetText [77782, _data select 5];
		...
		ctrlSetText [71327, _data select 5];
