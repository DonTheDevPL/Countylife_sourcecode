    ...
    */
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "ivory_rs4_marked_so", ""},
            { "ivory_m3_marked_so", ""},
            { "tw_vic_marked_sheriff", ""},
            { "ivory_isf_marked_so", ""},
            { "ivory_evox_marked_so_amg", "call life_coplevel >= 3"},
            { "ivory_evox_marked_so", ""},
            { "Faisal_Youkun2015_PD", ""},
            //{ "ivory_wrx_marked", ""},
            { "ivory_evox_pursuit_so", "call life_coplevel >= 1"},
            { "ivory_rs4_pursuit_so", ""},
            { "ivory_m3_unmarked", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "ivory_isf_unmarked", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "ivory_wrx_unmarked", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "AMG_Charger_12", "license_cop_aia || license_cop_dtu || license_cop_swat" },
            { "tw_raptor_unmarked", "license_cop_aia || license_cop_dtu || license_cop_swat" },
            { "ivory_evox_dtu", "license_cop_dtu"},
            { "AlessioBM4M", "license_cop_dtu"},
            { "AlessioMustangMat", "license_cop_dtu"},
            { "RS6_Avantlu_civ", "license_cop_dtu"},
            { "RS7lu_civ", "license_cop_dtu"},
            { "ivory_supra_topsecret", "license_cop_dtu && call life_coplevel >= 2"},
            { "Model_Slu_civ", "license_cop_dtu"},
            { "ivory_evox_unmarked", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "FaisalAlYahya_CVPI_police", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "mondeovch_bac", "license_cop_aia || license_cop_dtu || license_cop_swat"},
            { "mondeoswch_bac", "license_cop_aia || license_cop_dtu || license_cop_swat" },
            { "chgolf7_bac", "license_cop_aia || license_cop_dtu || license_cop_swat" },
            { "tw_durango_unmarked", "license_cop_aia || license_cop_dtu" },
            { "chvwt5_raid", "license_cop_swat" }
        };
    };
...
class LifeCfgVehicles {
    ...
    */
    ...
    class tw_raptor_marked_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_rs4_marked_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_m3_marked_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class tw_vic_marked_sheriff {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_isf_marked_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_evox_marked_so_amg {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_evox_marked_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_evox_pursuit_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_rs4_pursuit_so {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    };
    class ivory_evox_dtu {
        vItemSpace = 100;
        conditions = "";
        price = 1000;
        textures[] = {};
    ...
    class A3L_Charger_SERTOfficial {
        vItemSpace = 100;
        conditions = "";
        price = 30000;
        textures[] = {};
    ...
    class A3L_Charger_DTUSupervisor {
        vItemSpace = 100;
        conditions = "";
        price = 30000;
        textures[] = {};
    ...
    class chvwt5_raid {
        ...
        textures[] = {
            ...
            { "Tacticool", "cop", {
                "#(argb,8,8,3)color(0.125,0.157,0.071,1)",
                "#(argb,8,8,3)color(0.125,0.157,0.071,1)",
                "#(argb,8,8,3)color(0.125,0.157,0.071,1)"
            }, "" }
        };
