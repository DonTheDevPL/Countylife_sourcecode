...
class cl_phone_base_RscScrollBar
{
    color[] = {1,1,1,0.6};
    colorActive[] = {1,1,1,1};
...
class cl_phone_base_RscControlsGroup {
    type = 15;
    idc = -1;
    x = 0;
    y = 0;
    ...
    class VScrollBar : cl_phone_base_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : cl_phone_base_RscScrollBar
    {
        height = 0.028;
    };
...
class cl_phone_base_RscControlsGroupNoScrollbars : cl_phone_base_RscControlsGroup {
...
class cl_phone_base_RscListNBox
{
    style = 16;
    type = 102;
    shadow = 0;
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: cl_phone_base_RscScrollBar{};
    class ScrollBar: cl_phone_base_RscScrollBar{};
};


class cl_phone_base_RscText {
    x = 0;
    y = 0;
    h = 0.037;
    w = 0.3;
...
class cl_phone_base_RscLine: cl_phone_base_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class cl_phone_base_RscTitle: cl_phone_base_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class cl_phone_base_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class cl_phone_base_RscTextMulti: cl_phone_base_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class cl_phone_base_RscPictureKeepAspect : cl_phone_base_RscPicture
{
    style = 0x30 + 0x800;
};

class cl_phone_base_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class cl_phone_base_RscActiveText {
idc = -1;
    type = 11;
    style = 0;
    x = 0;
...
class cl_phone_base_RscButtonTextOnly : cl_phone_base_RscButton {
    SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
    colorBackground[] = {1, 1, 1, 0};
...
class cl_phone_base_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    shadow = 1;
...
class cl_phone_base_RscButtonMenu : cl_phone_base_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class cl_phone_base_RscShortcutButtonMain : cl_phone_base_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class cl_phone_base_RscCheckbox {
    idc = -1;
    type = 7;
    style = 0;
    x = "LINE_X(XVAL)";
...
class cl_phone_base_RscProgress
{
    type = 8;
    style = 0;
    x = 0.344;
...
class cl_phone_base_RscListBox
{
    style = 16;
    idc = -1;
    type = 5;
...
class cl_phone_base_RscSlider {
    h = 0.025;
    color[] = {1, 1, 1, 0.8};
    colorActive[] = {1, 1, 1, 1};
};

class cl_phone_base_RscXSliderH
{
    style = 1024;
    type = 43;
    shadow = 2;
...
class cl_phone_base_RscBackground: cl_phone_base_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class cl_phone_base_RscHitZones {
    x = 0;
    y = 0;
    w = 0.1;
    h = 0.1;
...
class cl_phone_base_RscMapControl
{
    //access = 0;
    type = 101;
    idc = 51;
...
class cl_phone_base_RscCombo {
    ...
    class ComboScrollBar : cl_phone_base_RscScrollBar {};
};

class cl_phone_base_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
...
class cl_phone_base_RscButtonMenu_special : cl_phone_base_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
