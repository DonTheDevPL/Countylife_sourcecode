...
if (player getVariable ["isEscorting",false]) then {
    { _x ctrlShow false; } forEach [_Btn1,_Btn2,_Btn3,_Btn5,_Btn6,_Btn7,_Btn8,_Btn9,_Btn10,_Btn11,_Btn12,_Btn13,_Btn14,_Btn15,_Btn16,_Btn17,_Btn18,_Btn19,_Btn20,_Btn21];
};
...
//Rozwiąż
_Btn9 ctrlSetText "Rozwiąż";
_Btn9 buttonSetAction "[life_pInact_curTarget] call life_fnc_untie; closeDialog 0;";

//Prawo jazdy
_Btn10 ctrlSetText "Prawo jazdy";
_Btn10 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_revokeDriverLicense; closeDialog 0;";

//Gun license
_Btn11 ctrlSetText "Broń";
_Btn11 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_revokeGunLicense; closeDialog 0;";
