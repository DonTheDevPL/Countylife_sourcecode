...
class WeaponShops {
    ...
    class gun {
        ...
        items[] = {
			...
			{ "RH_g19t", "", 10000, 0, "" },
			{ "RH_vp70", "", 10000, 0, "" },
			{ "hlc_pistol_P226R_Combat", "", 11000, 0, "" },
			{ "hlc_pistol_P226R_Elite", "", 12000, 0, "" },
			{ "CG_BAT", "", 500, 0, "" },
    ...
    class cop_so {
        ...
        items[] = {
			...
			{ "CSW_M870", "", 500, 0, "call life_coplevel >= 4" },
			{ "hlc_smg_MP5N", "", 500, 0, "call life_coplevel >= 4" },
			{ "hlc_smg_mp5k", "", 750, 0, "call life_coplevel >= 3" },
			{ "hlc_rifle_mk18mod0", "", 500, 0, "call life_coplevel >= 4" },
			...
			{ "RH_deagle", "", 10, 0, "call life_coplevel >= 3" },
			{ "RH_deagleg", "", 1000, 0, "call life_coplevel >= 7" },
			{ "RH_deagles", "", 650, 0, "call life_coplevel >= 6" },
			{ "RH_deaglem", "", 650, 0, "call life_coplevel >= 4" },
			{ "hlc_rifle_Colt727", "", 1000, 0, "call life_coplevel >= 4" },
			{ "hlc_smg_mp5sd5", "", 650, 0, "call life_coplevel >= 4" },
			{ "hlc_pistol_P226R_357Combat", "", 650, 0, "call life_coplevel >= 1" },
			{ "hlc_pistol_P226R_357Elite", "", 650, 0, "call life_coplevel >= 2" },
			{ "hlc_pistol_P229R_357Elite", "", 650, 0, "call life_coplevel >= 3" },
			{ "hlc_pistol_Mk25TR", "", 650, 0, "call life_coplevel >= 4" },
    ...
    class cop_swat {
        ...
        items[] = {
			...
			{ "HandGrenade_Stone", "Flashbang", 100, 0, "call life_coplevel >= 1" },
            ...
            { "hlc_rifle_bcmblackjack", "", 2500, 0, "call life_coplevel >= 2" },
            { "hlc_rifle_RU5562", "", 2500, 0, "call life_coplevel >= 1" },
            { "CSW_M870", "", 2500, 0, "call life_coplevel >= 2" },
            ...
            { "arifle_SDAR_F", "", 250, 0, "call life_coplevel >= 1" },
			{ "RH_deagle", "", 650, 0, "call life_coplevel >= 2" },
			{ "RH_deagleg", "", 1000, 0, "call life_coplevel >= 7" },
			{ "RH_deagles", "", 650, 0, "call life_coplevel >= 6" },
			{ "RH_deaglem", "", 650, 0, "call life_coplevel >= 3" },
			{ "hlc_smg_mp5k", "", 500, 0, "call life_coplevel >= 3" },
			{ "hlc_rifle_ACR_mid_black", "", 3000, 0, "" }			
        };
        mags[] = {
    ...
    class cop_dtu {
        ...
        items[] = {
			...
			{ "ItemGPS", "", 100, 0, ""},
			{ "Binocular", "", 100, 0, ""},
			{ "TRYK_Headset_NV", "Noktowizja", 100, 0, "call life_coplevel >= 1" },
			{ "CSW_M26C", "Paralizator", 100, 0, "call life_coplevel >= 1" },
			{ "tf_anprc152", "Radio", 100, 0, ""},
			{ "RH_uspm", "", 500, 0, "call life_coplevel >= 1" },
			{ "RH_g18", "", 500, 0, "call life_coplevel >= 1" },
			{ "RH_fnp45", "", 500, 0, "call life_coplevel >= 2" },
            { "RH_deagles", "", 650, 0, "call life_coplevel >= 2" },	
            { "RH_Deagleg", "", 650, 0, "call life_coplevel >= 3" },	
     ...
     class cop_aia {
        ...
        items[] = {
			...
			{ "RH_M9", "", 2000, 0, "call life_coplevel >= 1" },
			{ "RH_cz75", "", 2000, 0, "call life_coplevel >= 1" },
			{ "RH_uspm", "", 2000, 0, "call life_coplevel >= 1" },
			{ "RH_fnp45", "", 2000, 0, "call life_coplevel >= 1" },
			{ "RH_usp", "", 2000, 0, "call life_coplevel >= 1" },
			{ "RH_g19", "", 2000, 0, "call life_coplevel >= 1" },
