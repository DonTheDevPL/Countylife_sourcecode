...
/* System Settings */
    ...
    respawn_timer = 3*60; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    escapeMenu_displayText = "BattleLog??"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    sendtoJail_locations[] = { "police_hq_1","Correctional_Facility" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    crimes[] = {
        {"STR_Crime_187V","15000","187V"},//Potrącenie
        //{"STR_Crime_187","xxx","187"},//Usuń
        {"STR_Crime_901","350000","901"},//Ucieczka z więzienia
        {"STR_Crime_215","15000","215"},// Próba kradzieży pojazdu
        {"STR_Crime_213","100000","213"},//Włamanie się do sejfu
        {"STR_Crime_211","45000","211"},
        {"STR_Crime_207","95000","207"},
        {"STR_Crime_207A","47500","207A"},
        {"STR_Crime_390","5000","390"},
        //{"STR_Crime_487","xxx","487"},//Usuń
        {"STR_Crime_488","10000","488"},//Drobna kradzież
        {"STR_Crime_480","25000","480"},//Ucieczka przed policją
        {"STR_Crime_481","30000","481"},
        {"STR_Crime_482","20000","482"},//Zamiar dystrybucji
        {"STR_Crime_483","40000","483"},
        {"STR_Crime_459","60000","459"},
        //{"STR_Crime_666","xxx","666"},//Usuń
        {"STR_Crime_667","80000","667"},
        //{"STR_Crime_668","xxx","668"},//Usuń
        {"STR_Crime_1","500","1"},
        {"STR_Crime_2","5000","2"},
        {"STR_Crime_3","1000","3"},//Nie przestrzeganie sygnalizacji świetlnej
        {"STR_Crime_4","1000","4"},//Przekroczenie prędkości
        {"STR_Crime_5","5000","5"},
        {"STR_Crime_6","750","6"},//Jazda bez kasku gokartem
        {"STR_Crime_7","150","7"},
        //{"STR_Crime_8","xxx","8"},//Usuń
        {"STR_Crime_9","30000","9"},//Kradzież pojazdu (cywilny)
        {"STR_Crime_10","60000","10"},//Kradzież pojazdu (policja)
        //{"STR_Crime_11","xxx","11"},//Usuń
        //{"STR_Crime_12","2500","12"},//Usuń
        {"STR_Crime_13","15000","13"},
        {"STR_Crime_14","25000","14"},//Otwarcie ognia
        {"STR_Crime_15","55000","15"},//Nielegalna broń
        {"STR_Crime_16","30000","16"},
        {"STR_Crime_17","5000","17"},//Maska w miejscu publicznym
        {"STR_Crime_18","12500","18"},//Odmowa współpracy
        {"STR_Crime_19","10000","19"},//Składanie fałszywych zeznań
        {"STR_Crime_20","5000","20"},//Obrażanie cywila
        {"STR_Crime_21","7500","21"},//Obraza funkcjonariusza
        //{"STR_Crime_22","2000","22"},//Usuń
        //{"STR_Crime_23","5000","23"},//Usuń
        {"STR_Crime_24","130000","24"},//Zabójstwo cywila
        {"STR_Crime_25","200000","25"}//Zabójstwo funkcjonariusza
    };
};
