...
private _hideoutObjs = [[["Malden", _altisArray], ["Tanoa", _tanoaArray]]] call TON_fnc_terrainSort;
...
_markerMsg = format["Przejęte przez: %1",(group player) getVariable "gang_name"];
_pos = position player;
_marker = createMarker ["GangMarker", _pos]; //by ehno: Place a Maker on the map
"Marker200" setMarkerColor "ColorBlue";
"Marker200" setMarkerText _markerMsg;
