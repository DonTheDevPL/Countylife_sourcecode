...
if ((life_inv_toolkit > 0) || (("ToolKit" in items player) && (occupation == "Mechanik"))) then  {
        ...
        for "_i" from 0 to 1 step 0 do {
            ...
            uiSleep 0.27;
            _cP = _cP + (0.01 * (missionNamespace getVariable ["mav_ttm_var_repairspeedMultiplier", 1]));
        ...
        if ((playerSide isEqualTo civilian && (_sideRepairArray select 0) isEqualTo 0) && (occupation != "Mechanik")) then {
