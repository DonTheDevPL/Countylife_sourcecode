...
if(FactoryCount == 1) exitWith {hint "możesz posiadć tylko jendą fabryke";};
...
if (_action) then {
    ...
    if(typeOf _house in ["Land_Addon_05_F","Land_dp_smallFactory_F","Land_i_Shed_Ind_F","Land_MilOffices_V1_F"])then {
        FactoryCount = 1;
    };
