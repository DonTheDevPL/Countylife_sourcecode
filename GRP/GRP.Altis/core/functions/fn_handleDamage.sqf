...
if (!isNull _source) then {
    if (_source != _unit) then {
        if (currentWeapon _source in ["hgun_P07_snds_F","arifle_SDAR_F","Mossberg_590","CSW_M26C"] && _projectile in ["B_9x21_Ball","B_556x45_dual","590_00buckshot","CSW_Taser_Ammo"]) then {
