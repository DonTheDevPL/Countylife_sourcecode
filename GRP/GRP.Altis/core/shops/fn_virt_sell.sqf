...
if(_amount >= 100) exitWith {hint "Wpisz mniejsza liczbe";};
...
if(life_shop_type isEqualTo "drugdealer" || life_shop_type isEqualTo "drugdealer_bieda") then {
    ["drugTrade"] spawn mav_ttm_fnc_addExp;
} else {
    ["trade"] spawn mav_ttm_fnc_addExp;
};
