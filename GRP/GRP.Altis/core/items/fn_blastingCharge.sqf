...
if (typeOf _vault != "cg_mainvault") exitWith {hint localize "STR_ISTR_Blast_VaultOnly"};
...
[[0,1],"STR_ISTR_Blast_Placed",true,[]] remoteExecCall ["life_fnc_broadcast",west];
hint localize "STR_ISTR_Blast_KeepOff";

[] remoteExec ["life_fnc_demoChargeTimer",[west,independent,player]];
