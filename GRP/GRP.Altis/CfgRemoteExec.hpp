...
class CfgRemoteExec {
    class Functions {
        ...
        F(life_fnc_tieing,CLINET)
        F(life_fnc_tieingb,CLINET)
        F(life_fnc_gagged,CLINET)
        F(life_fnc_pattedDown,CLINET)
        F(life_fnc_strippedDown,CLINET)
        F(life_fnc_backup,CLIENT)
        F(life_fnc_morphine,CLIENT)
        F(life_fnc_bandages,CLIENT)
        F(life_fnc_pawulon,CLIENT)
        F(life_fnc_prepawulon,CLIENT)
        F(life_fnc_medkit,CLIENT)
        F(life_fnc_reciveid,CLIENT)
        F(life_fnc_recivebadge,CLIENT)
